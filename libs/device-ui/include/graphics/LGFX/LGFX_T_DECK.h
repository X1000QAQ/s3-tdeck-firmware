...
#endif
{
    ...
    lgfx::Touch_FT5x06 _touch_instance; // 本机触摸=FocalTech FT6236(I2C 0x38)，非 GT911
  ...
  public:
    ...
    LGFX_TDECK(void)
    {
        ...
        {                                        // Set the display panel control.
            ...
            cfg.offset_rotation = 3;        // 本机面板与原版 T-Deck 差 180°：1->3（LovyanGFX: internal_rotation 3 即正确方向，5 会左右镜像）
            cfg.dummy_read_pixel = 8;       // Number of bits for dummy read before pixel readout
            cfg.dummy_read_bits = 1;        // Number of bits for dummy read before non-pixel data read
            cfg.readable = true;            // Set to true if data can be read
            cfg.invert = false;             // 本机面板与原版 T-Deck 相反：反相会让主题色偏紫、深浅主题互换
        ...
        // Configure settings for touch screen control.
        {
            ...
            // I2C
            cfg.i2c_port = 0;
            cfg.i2c_addr = 0x38;   // 实测：0x38 有应答，0x5D/0x14（GT911）无应答
            cfg.pin_sda = 18;
            cfg.pin_scl = 8;
            cfg.bus_shared = true;
            cfg.freq = 400000;
