...
#define LV_CACHE_DEF_SIZE       2097152 /* 2MB: 缓存需容纳一屏瓦片，否则滚动时反复从 SD 重读 (#272) */
#endif
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(ui_font_montserrat_12) LV_FONT_DECLARE(ui_font_montserrat_14) LV_FONT_DECLARE(ui_font_montserrat_16) LV_FONT_DECLARE(ui_font_montserrat_20) LV_FONT_DECLARE(ui_font_cjk_16)
...
#define LV_USE_IME_PINYIN 1
    ...
    #define LV_IME_PINYIN_USE_DEFAULT_DICT 0   /* 改用自带的简体词典 lv_pinyin_dict_zh */
